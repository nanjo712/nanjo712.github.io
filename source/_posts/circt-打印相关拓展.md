...
zhihu-updated-at: 2026-04-21 16:58
title: CIRCT——打印相关拓展
...
- [[SimToSV] support lowering stdout/stderr](https://github.com/llvm/circt/pull/10283)
- [[LowerToHW] Extract the logic related to file descriptor acquisition as a common utility function](https://github.com/llvm/circt/pull/10288)
...
- ~~引入表达stdout和stderr的sim操作（[#10206](https://github.com/llvm/circt/pull/10206))~~ ✅️ 
- ~~为没有显式指定流的打印操作引入表达`$write`的sv操作（[#10179](https://github.com/llvm/circt/pull/10179)）~~✅️
	- ~~维护者指出最好把测试集中在一个文件里面（[#10205](https://github.com/llvm/circt/pull/10205)）~~✅️
- ~~实现`sim.proc.print`的降级逻辑（[#10172](https://github.com/llvm/circt/pull/10172)）~~ ✅️
...
- 实现sim.stdout_stream/sim.stderr_stream的降级逻辑（[#10283](https://github.com/llvm/circt/pull/10283)）
- 实现sim.get_file的降级逻辑
	- 抽离FIRRTLToHW中目前生成CIRCT内部日志库的逻辑作为公共Utils，以便后续复用（[#10288](https://github.com/llvm/circt/pull/10288)）
